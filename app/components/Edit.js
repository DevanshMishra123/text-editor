...
export default function Edit({inValue, hasLoaded}) {
  ...
  return (
    <div className="dark:bg-gray-900 dark:text-white w-[80vw] max-w-4xl h-[80vh] mx-auto m-5 border border-gray-300 shadow-lg rounded-xl bg-white overflow-hidden">
